...
static volatile int64_t g_10[10] = {(-1L),(-4L),(-1L),(-1L),(-4L),(-1L),(-1L),(-4L),(-1L),(-1L)};
static volatile uint64_t g_11 = 0x3A4C924B54114571LL;/* VOLATILE GLOBAL g_11 */
