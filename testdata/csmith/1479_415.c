...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0x5C62E089L;/* VOLATILE GLOBAL g_2 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int32_t *l_9 = &g_10[0];
        (*l_9) |= (safe_add_func_int16_t_s_s((l_8 , g_2), g_3));
        return g_3;
    }
    for (l_8 = 0; (l_8 > 7); l_8 = safe_add_func_uint16_t_u_u(l_8, 8))
    { /* block id: 9 */
        return g_2;
    }
    return l_8;
