...
/* --- GLOBAL VARIABLES --- */
static struct S0 g_2 = {-80,-8,0,9,896,7656,89,13,0xB94D0F4FL};/* VOLATILE GLOBAL g_2 */
static volatile struct S1 g_3 = {1,67,39,913,307};/* VOLATILE GLOBAL g_3 */
static volatile struct S1 g_4 = {0,153,38,592,363};/* VOLATILE GLOBAL g_4 */
...
{ /* block id: 0 */
    ...
    int32_t l_6 = 0L;
    int32_t *l_7[2];
    uint8_t l_8[8] = {253UL,253UL,253UL,253UL,253UL,253UL,253UL,253UL};
    int i;
    for (i = 0; i < 2; i++)
        l_7[i] = &l_6;
    g_4 = (g_2 , g_3);
